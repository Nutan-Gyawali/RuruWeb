...
export const HeroSection = ({ language, heroImage, eyebrow, headline, body }: HeroSectionProps) => {
    ...
    return (
        <section className="relative isolate flex min-h-[340px] items-end overflow-hidden bg-ink text-paper sm:min-h-[400px] lg:min-h-[460px]">
            ...
            <div className="relative mx-auto w-full max-w-7xl px-6 pb-10 pt-16 sm:pb-12 sm:pt-20">
                ...
                <button
                    ...
                    className="mt-7 flex items-center gap-2 border border-paper/40 bg-ink/20 px-6 py-3 text-xs font-semibold uppercase tracking-[0.15em] text-paper backdrop-blur-sm transition-colors hover:border-brand-on-ink hover:text-brand-on-ink"
                >
