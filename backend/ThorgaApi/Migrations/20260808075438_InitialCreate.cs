        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameNe = table.Column<string>(type: "text", nullable: true),
                    PositionEn = table.Column<string>(type: "text", nullable: true),
                    PositionNe = table.Column<string>(type: "text", nullable: true),
                    DescriptionEn = table.Column<string>(type: "text", nullable: true),
                    DescriptionNe = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleNe = table.Column<string>(type: "text", nullable: true),
                    BodyEn = table.Column<string>(type: "text", nullable: true),
                    BodyNe = table.Column<string>(type: "text", nullable: true),
                    SummaryEn = table.Column<string>(type: "text", nullable: true),
                    SummaryNe = table.Column<string>(type: "text", nullable: true),
                    SortOrder = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonProfiles_Category_Name",
                table: "PersonProfiles",
                columns: new[] { "Category", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_SiteContents_Category_Title",
                table: "SiteContents",
                columns: new[] { "Category", "Title" });

            migrationBuilder.CreateIndex(
                name: "IX_SiteImages_Category_Title",
                table: "SiteImages",
                columns: new[] { "Category", "Title" });
        }
